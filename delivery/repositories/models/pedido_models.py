...
class PedidoModel(models.Model):
    cliente = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)  # Relacionando o pedido a um cliente (usuário)
    ...
    data_atualizacao = models.DateTimeField(auto_now=True)  # Data de última atualização do pedido
